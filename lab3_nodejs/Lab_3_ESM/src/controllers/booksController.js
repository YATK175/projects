...
import { bookCreateSchema, bookPatchSchema } from '#validators/book.schema';
import { idParamsSchema } from '#validators/params.schema';
import { bookQuerySchema } from '#validators/query.schema';
...
export { getBooks, getBookById, createBook, patchBook, putBook, deleteBook };
